...
options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            if (!util_1.isUndefined(options.timeoutS)) {
                fetchTimeout = options.timeoutS * 1000;
            }
            if (!util_1.isUndefined(options.init)) {
                init = options.init;
            }
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    var timeout;
                    if (!util_1.isUndefined(fetchTimeout)) {
...
var ApiRequest = /** @class */ (function () {
     ...
     */
    ApiRequest.process = function (response) {
        return response;
    };
    /**
    ...
    ApiRequest.prototype.send = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var defaultOptions, _a, url, init, response, contentType, jsonResponse;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, ApiRequest.process(jsonResponse)];
                }
            });
        });
    };
