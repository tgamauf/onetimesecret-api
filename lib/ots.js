...
var OneTimeSecretApi = /** @class */ (function () {
    ...
    function OneTimeSecretApi(username, password, options) {
        ...
        if (util_1.isUndefined(username) || util_1.isUndefined(password)) {
    ...
    OneTimeSecretApi.prototype.retrieveSecret = function (secretKey, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (util_1.isUndefined(secretKey)) {
    ...
    OneTimeSecretApi.prototype.retrieveMetadata = function (metadataKey) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (util_1.isUndefined(metadataKey)) {
                    ...
                    case 1:
                        response = _a.sent();
                        if (util_1.isUndefined(response.secret_key)) {
