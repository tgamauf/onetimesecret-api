...
var OneTimeSecretApi = /** @class */ (function () {
    ...
    function OneTimeSecretApi(username, password, options) {
        ...
        this.init = __assign({ username: username, password: password }, defaultOptions, options);
        // The api version is also required in the request
        this.apiVersion = this.init.apiVersion;
    }
    OneTimeSecretApi.prototype.createSecretUrl = function (secret_key) {
     ...
     */
    OneTimeSecretApi.prototype.retrieve_secret = function (secret_key, options) {
        return __awaiter(this, void 0, void 0, function () {
            var init, request;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        init = __assign({}, JSON.parse(JSON.stringify(this.init)), { secret_key: secret_key }, options);
     ...
     */
    OneTimeSecretApi.prototype.retrieve_metadata = function (metadata_key) {
        return __awaiter(this, void 0, void 0, function () {
            var init, request;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        init = __assign({}, JSON.parse(JSON.stringify(this.init)), { metadata_key: metadata_key });
     ...
     * @throws error if no metadata key defined or connection/request fails
     */
    OneTimeSecretApi.prototype.burn = function (metadata_key) {
        return __awaiter(this, void 0, void 0, function () {
            var init, request;
            return __generator(this, function (_a) {
                switch (_a.label) {
